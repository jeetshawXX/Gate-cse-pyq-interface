  ...
  "sections": [
    {
      ...
      "questions": [
        ...
        {
          "id": 9,
          "question": "<p><a name=\"473104\"></a><div itemprop=\"text\"><p>What is the largest number of knights that can be placed on a \\( 60 \\times 60 \\) chessboard such that no two knights attack each other (two knights attack each other if they are two steps away vertically and one step away horizontally, or vice versa).</p><p style=\"text-align:center\"><img alt=\"\" width=\"400\" height=\"400\" src=\"https://gateoverflow.in/?qa=blob&amp;qa_blobid=8412656614246198243\"></p><p>The figure above shows a part of a chessboard showing all those squares that a knight placed in the central white square attacks.</p></div><br><br><b>Graph Theory: TIFR CSE 2025 | Part A | Question: 9</b></p>",
          "type": "single",
          "options": [
            "<p>\\( 1200 \\)</p>",
            "<p>\\( 1500 \\)</p>",
