  ...
  "sections": [
    {
      ...
      "questions": [
        ...
        {
          "id": 2,
          "question": "<p><a name=\"2767\"></a><div itemprop=\"text\"><p>Insert the characters of the string \\( K \\ R \\ P \\ C \\ S&nbsp; \\ N \\ Y \\ T \\ J \\ M \\) into a hash table of size \\( 10 \\).</p>\n\n<p>Use the hash function</p>\n\n<p>\\[ h(x)=( ord (x) – ord (\\text{“}a\\text{”}) + 1) \\mod 10 \\]</p>\n\n<p>and linear probing to resolve collisions.</p>\n\n</div><br><br><b>GATE CSE 1996 | Question: 15</b></p>",
          "type": "numeric",
          "options": [
            "<p>Which insertions cause collisions?</p>",
            "<p>Display the final hash table.</p>"
          ],
          "correct_answer": "N/A",
          "marks": 1,
          "negative_marks": 0,
          "explanation": "<p><a href=\"https://gateoverflow.in/2767/gate-cse-1996-question-15\" target=\"_blank\">https://gateoverflow.in/2767/gate-cse-1996-question-15</a></p>"
        },
        {
          "id": 3,
          "question": "<p><a name=\"2272\"></a><div itemprop=\"text\"><p>Consider a hash table with \\( n \\) buckets, where external (overflow) chaining is used to resolve collisions. The hash function is such that the probability that a key value is hashed to a particular bucket is \\( \\frac{1}{n} \\). The hash table is initially empty and \\( K \\) distinct values are inserted in the table.</p>\n\n</div><br><br><b>GATE CSE 1997 | Question: 12</b></p>",
          "type": "numeric",
          "options": [
            "<p>What is the probability that bucket number \\( 1 \\) is empty after the \\( K^{th} \\) insertion?</p>",
            "<p>What is the probability that no collision has occurred in any of the \\( K \\) insertions?</p>",
            "<p>What is the probability that the first collision occurs at the \\( K^{th} \\) insertion?</p>"
          ],
          "correct_answer": "N/A",
          "marks": 1,
          "negative_marks": 0,
          "explanation": "<p><a href=\"https://gateoverflow.in/2272/gate-cse-1997-question-12\" target=\"_blank\">https://gateoverflow.in/2272/gate-cse-1997-question-12</a></p>"
        },
        {
          "id": 4,
