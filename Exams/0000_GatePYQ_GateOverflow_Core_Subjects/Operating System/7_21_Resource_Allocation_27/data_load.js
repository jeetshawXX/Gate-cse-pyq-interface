  ...
  "sections": [
    {
      ...
      "questions": [
        {
          "id": 1,
          "question": "<p><a name=\"94397\"></a><div itemprop=\"text\"><p>A number of processes could be in a deadlock state if none of them can&nbsp;execute due to non-availability of sufficient resources. Let \\( P_i, 0 \\leq i&nbsp; \\leq 4 \\) represent five processes and let there be four resources types \\( r_j, 0 \\leq j \\leq 3 \\). Suppose the following data structures have been used.</p><p><strong>Available:</strong> A vector of length \\( 4 \\) such that if Available \\( [i]=k \\), there are k instances of resource type \\( r_j \\) available in the system.</p><p><strong>Allocation. </strong>A \\( 5 \\times&nbsp;4 \\) matrix defining the number of each type currently allocated to each process. If Allocation \\( [i,j]=k \\) then process \\( p_i \\) is currently allocated \\( k \\) instances of resource type \\( r_j \\).</p><p><strong>Max.</strong> A \\( 5 \\times&nbsp;4 \\) matrix indicating the maximum resource need of each process. If \\( Max[i,j]=k  \\) then process \\( p_i \\), may need a maximum of \\( k \\) instances of resource type \\( r_j \\) in order to complete the task.</p><p>Assume that system allocated resources only when it does not lead into an unsafe state such that resource requirements in future never&nbsp;cause a deadlock state. Now consider the following snapshot of the system.\\[ \\overset{\\Large{\\text{Allocation}}}{\\begin{array}{|l|lll|} \\hline &amp; r_{0} &amp; r_{1} &amp; r_{2} &amp; r_{3} \\\\\\hline&nbsp; p_{0} &amp; 0 &amp; 0 &amp; 1 &amp; 2&nbsp; \\\\&nbsp; p_{1} &amp; 1&nbsp;&amp; 0&nbsp;&amp; 0&nbsp;&amp; 0&nbsp; \\\\&nbsp; p_{2} &amp; 1&nbsp;&amp; 3&nbsp;&amp; 5&nbsp;&amp; 4&nbsp; \\\\&nbsp; p_{3} &amp; 0 &amp; 6&nbsp;&amp; 3&nbsp;&amp; 2&nbsp; \\\\&nbsp; p_{4} &amp; 0 &amp; 0 &amp; 1 &amp; 4&nbsp;\\\\\\hline \\end{array}}\\quad \\qquad \\overset{\\Large{\\text{Max}}}{\\begin{array}{|llll|} \\hline r_{0} &amp; r_{1} &amp; r_{2} &amp; r_{3} \\\\\\hline&nbsp; &nbsp;0 &amp; 0 &amp; 1 &amp; 2&nbsp; \\\\&nbsp; &nbsp;1&nbsp;&amp; 7&nbsp;&amp; 5&nbsp;&amp; 0&nbsp; \\\\ 2&nbsp;&amp; 3&nbsp;&amp; 5&nbsp;&amp; 6&nbsp; \\\\&nbsp; &nbsp;0 &amp; 6&nbsp;&amp; 5&nbsp;&amp; 2&nbsp; \\\\&nbsp; &nbsp;0 &amp; 6&nbsp;&amp; 5&nbsp;&amp; 6&nbsp;\\\\\\hline \\end{array}} \\qquad \\quad \\overset{\\Large{\\text{Available}}}{\\begin{array}{|llll|} \\hline r_{0} &amp; r_{1} &amp; r_{2} &amp; r_{3} \\\\\\hline&nbsp; 1 &amp; 5&nbsp;&amp; 2&nbsp;&amp; 0&nbsp; \\\\\\hline \\end{array}} \\]Is the system currently in a safe state? If yes, explain why.</p></div><br><br><b>GATE CSE 1988 | Question: 11</b></p>",
          "type": "numeric",
          "options": [],
          "correct_answer": "N/A",
          "marks": 1,
          "negative_marks": 0,
          "explanation": "<p><a href=\"https://gateoverflow.in/94397/gate-cse-1988-question-11\" target=\"_blank\">https://gateoverflow.in/94397/gate-cse-1988-question-11</a></p>"
        },
        {
          "id": 2,
          "question": "<p><a name=\"91093\"></a><div itemprop=\"text\"><ol start=\"1\" style=\"list-style-type:lower-roman\">\n<li>A system of four concurrent processes, \\( P, Q, R \\) and \\( S \\), use shared resources \\( A, B \\) and \\( C \\). The sequences in which processes, \\( P, Q, R \\) and \\( S \\) request and release resources are as follows:</li>\n</ol>\n\n<p>\\[ \\begin{array}{ll}&nbsp;<br>\n\\text{ Process&nbsp; P: } &amp;&nbsp; \\text{1.}&amp; \\text{ P requests A } &amp;&amp;&nbsp; \\\\&nbsp;&nbsp;<br>\n\\text{&nbsp; } &amp;&nbsp; \\text{2.}&amp; \\text{ P requests B } &amp;&amp; \\\\&nbsp;<br>\n&nbsp;\\text{ } &amp;&nbsp; \\text{3.}&amp; \\text{ P releases A } &amp;&amp;\\\\<br>\n\\text{} &amp;&nbsp; \\text{4.}&amp; \\text{ P releases B } &amp;&amp; \\\\<br>\n\\text{ Process&nbsp; Q: } &amp;&nbsp; \\text{1.}&amp; \\text{ Q requests C } &amp;&amp;&nbsp; \\\\&nbsp;&nbsp;<br>\n\\text{&nbsp; } &amp;&nbsp; \\text{2.}&amp; \\text{ Q requests A } &amp;&amp; \\\\&nbsp;<br>\n\\text{ } &amp;&nbsp; \\text{3.}&amp; \\text{ Q releases C } &amp;&amp;\\\\<br>\n\\text{} &amp;&nbsp; \\text{4.}&amp; \\text{ P releases&nbsp; A } &amp;&amp;\\\\<br>\n\\text{ Process&nbsp; R: } &amp;&nbsp; \\text{1.}&amp; \\text{ R requests B } \\\\<br>\n&nbsp;\\text{&nbsp; } &amp;&nbsp; \\text{2.}&amp; \\text{ R requests C } \\\\<br>\n\\text{ } &amp;&nbsp; \\text{3.}&amp; \\text{ R releases&nbsp;B } &amp;&amp;\\\\<br>\n\\text{} &amp;&nbsp; \\text{4.}&amp; \\text{ R releases C } &amp;&amp;\\\\<br>\n\\text{ Process&nbsp; S: } &amp;&nbsp; \\text{1.}&amp; \\text{ S requests A } &amp;&amp;&nbsp; \\\\&nbsp;&nbsp;<br>\n\\text{&nbsp; } &amp;&nbsp; \\text{2.}&amp; \\text{ S requests C } &amp;&amp; \\\\&nbsp;<br>\n\\text{ } &amp;&nbsp; \\text{3.}&amp; \\text{ S releases&nbsp;A } &amp;&amp;\\\\<br>\n\\text{} &amp;&nbsp; \\text{4.}&amp; \\text{ S releases C } &amp;&amp;&nbsp; \\end{array} \\]</p>\n\n<p>If a resource is free, it is granted to a requesting process immediately. There is no preemption of granted resources. A resource is taken back from a process only when the process explicitly releases it.</p>\n\n<p>Can the system of four processes get into a deadlock? If yes, give a sequence (ordering) of operations (for requesting and releasing resources) of these processes which leads to a deadlock.</p>\n\n<ol start=\"2\" style=\"list-style-type:lower-roman\">\n<li>Will the processes always get into a deadlock? If your answer is no, give a sequence of these operations which leads to completion of all processes.</li>\n<li>What strategies can be used to prevent deadlocks in a system of concurrent processes using shared resources if preemption of granted resources is not allowed?</li>\n</ol></div><br><br><b>GATE CSE 1989 | Question: 11a</b></p>",
          "type": "numeric",
          "options": [],
          "correct_answer": "N/A",
          "marks": 1,
          "negative_marks": 0,
          "explanation": "<p><a href=\"https://gateoverflow.in/91093/gate-cse-1989-question-11a\" target=\"_blank\">https://gateoverflow.in/91093/gate-cse-1989-question-11a</a></p>"
        },
        {
          "id": 3,
        ...
        {
          "id": 4,
          "question": "<p><a name=\"2297\"></a><div itemprop=\"text\"><p>Consider a system having \\( m \\) resources of the same type. These resources are shared by \\( 3 \\) processes \\( A, B \\), and&nbsp;\\( C \\) which have peak demands of \\( 3, 4 \\), and \\( 6 \\) respectively.&nbsp; For what value of \\( m \\) deadlock will not occur?</p>\n\n</div><br><br><b>GATE CSE 1993 | Question: 7.9, UGCNET-Dec2012-III: 41</b></p>",
          "type": "numeric",
          "options": [
            "<p>\\( 7 \\)</p>",
            "<p>\\( 9 \\)</p>",
          ...
          "marks": 1,
          "negative_marks": 0,
          "explanation": "<p><a href=\"https://gateoverflow.in/2297/gate-cse-1993-question-7-9-ugcnet-dec2012-iii-41\" target=\"_blank\">https://gateoverflow.in/2297/gate-cse-1993-question-7-9-ugcnet-dec2012-iii-41</a></p>"
        },
        {
          "id": 5,
          "question": "<p><a name=\"2524\"></a><div itemprop=\"text\"><p>Consider the resource allocation graph in the figure.</p>\n\n<p style=\"text-align:center\"><img alt=\"\" src=\"images/gateOverflow_pyq_images/operating_system___resource_allocation/e5a26e384eebad7fc12da0bbc189ef84.png\" width=\"600\"></p>\n\n</div><br><br><b>GATE CSE 1994 | Question: 28</b></p>",
          "type": "numeric",
          "options": [
            "<p>Find if the system is in a deadlock state</p>",
            "<p>Otherwise, find a safe sequence</p>"
          ],
          "correct_answer": "N/A",
          "marks": 1,
          "negative_marks": 0,
          "explanation": "<p><a href=\"https://gateoverflow.in/2524/gate-cse-1994-question-28\" target=\"_blank\">https://gateoverflow.in/2524/gate-cse-1994-question-28</a></p>"
        },
        {
          "id": 6,
          "question": "<p><a name=\"2774\"></a><div itemprop=\"text\"><p>A computer system uses the Banker’s Algorithm to deal with deadlocks. Its current state is shown in the table below, where \\( P0 \\), \\( P1 \\), \\( P2 \\) are processes, and \\( R0 \\), \\( R1 \\), \\( R2 \\) are resources types.<br>\\[ \\overset{\\Large{\\text{Maximum Need}}}{\\begin{array}{|l|ll|} \\hline &amp; R{0} &amp; R{1} &amp; R{2} \\\\\\hline&nbsp; P{0} &amp; 4 &amp; 1 &amp; 2&nbsp; \\\\&nbsp; P{1} &amp; 1&nbsp;&amp; 5 &amp; 1&nbsp; \\\\&nbsp; P{2} &amp; 1&nbsp;&amp; 2 &amp; 3&nbsp; \\\\\\hline \\end{array}}\\quad \\qquad \\overset{\\Large{\\text{Current Allocation}}}{\\begin{array}{|l|lll|} \\hline &amp; R{0} &amp; R{1} &amp; R{2} \\\\\\hline&nbsp; P{0} &amp; 1 &amp; 0 &amp; 2&nbsp; \\\\&nbsp; P{1} &amp; 0 &amp; 3 &amp; 1&nbsp; \\\\&nbsp;P{2} &amp;&nbsp; 1 &amp; 0 &amp; 2 \\\\\\hline \\end{array}} \\qquad \\quad \\overset{\\Large{\\text{Available}}}{\\begin{array}{|lll|} \\hline R{0} &amp; R{1} &amp; R{2} \\\\\\hline&nbsp; 2 &amp; 2 &amp; 0&nbsp; \\\\\\hline \\end{array}} \\]</p></div><br><br><b>GATE CSE 1996 | Question: 22</b></p>",
          "type": "numeric",
          "options": [
            "<p>Show that the system can be in this state</p>",
            "<p>What will the system do on a request by process \\( P0 \\) for one unit of resource type \\( R1 \\)?</p>"
          ],
          "correct_answer": "N/A",
          "marks": 1,
          "negative_marks": 0,
          "explanation": "<p><a href=\"https://gateoverflow.in/2774/gate-cse-1996-question-22\" target=\"_blank\">https://gateoverflow.in/2774/gate-cse-1996-question-22</a></p>"
        },
        {
          "id": 7,
        ...
        {
          "id": 8,
          "question": "<p><a name=\"19705\"></a><div itemprop=\"text\"><p>An operating system handles requests to resources as follows.</p>\n\n<p>A process (which asks for some resources, uses them for some time and then exits the system) is assigned a unique timestamp are when it starts. The timestamps are monotonically increasing with time. Let us denote the timestamp of a process \\( P \\) by \\( TS(P) \\).</p>\n\n<p>When a process \\( P \\) requests for a resource the \\( OS \\) does the following:</p>\n\n<ol style=\"list-style-type:lower-roman\">\n\t<li>\n\t<p>If no other process is currently holding the resource, the \\( OS \\) awards the resource to \\( P \\).</p>\n\t</li>\n\t<li>\n\t<p>If some process \\( Q \\) with \\( TS(Q) &lt; TS(P) \\) is holding the resource, the \\( OS \\) makes \\( P \\) wait for the resources.</p>\n\t</li>\n\t<li>\n\t<p>If some process \\( Q \\) with \\( TS(Q)&gt;TS(P) \\) is holding the resource, the \\( OS \\) restarts \\( Q \\) and awards the resources to \\( P \\).&nbsp;(Restarting means taking back the resources held by a process, killing it and starting it again with the same timestamp)</p>\n\t</li>\n</ol>\n\n<p>When a process releases a resource, the process with the smallest timestamp (if any) amongst those waiting for the resource is awarded the resource.</p>\n\n</div><br><br><b>GATE CSE 1997 | Question: 75</b></p>",
          "type": "numeric",
          "options": [
            "<p>Can a deadlock over arise? If yes, show how. If not prove it.</p>",
            "<p>Can a process P ever starve? If yes, show how. If not prove it.</p>"
          ],
          "correct_answer": "N/A",
          "marks": 1,
          "negative_marks": 0,
          "explanation": "<p><a href=\"https://gateoverflow.in/19705/gate-cse-1997-question-75\" target=\"_blank\">https://gateoverflow.in/19705/gate-cse-1997-question-75</a></p>"
        },
        {
          "id": 9,
        ...
        {
          "id": 11,
          "question": "<p><a name=\"760\"></a><div itemprop=\"text\"><p>Two concurrent processes \\( P1 \\) and \\( P2 \\) want to use resources \\( R1 \\) and \\( R2 \\) in a mutually exclusive manner. Initially, \\( R1 \\) and \\( R2 \\) are free. The programs executed by the two processes are given below.</p>\n\n<p>\\[ \\begin{array}{|ll|ll|}\\hline &amp; \\textbf{Program for P1:}&nbsp; &amp;&amp;&nbsp; \\textbf{Program for P2:}&nbsp; \\\\\\hline&nbsp;<br>\n\\text{S1:} &amp; \\text{While (\\( R1 \\) is busy) do no-op;} &amp; \\text{Q1:} &amp; \\text{While (\\( R1 \\) is busy) do no-op;} \\\\<br>\n\\text{S2:} &amp; \\text{Set \\( R1 \\) \\( \\leftarrow \\) busy;} &amp; \\text{Q2:} &amp; \\text{Set \\( R1 \\) \\( \\leftarrow \\) busy;} \\\\<br>\n\\text{S3:} &amp; \\text{While (\\( R2 \\) is busy) do no-op;} &amp; \\text{Q3:} &amp; \\text{While (\\( R2 \\) is busy) do no-op;} \\\\<br>\n\\text{S4:} &amp; \\text{Set \\( R2 \\) \\( \\leftarrow \\) busy;} &amp; \\text{Q4:} &amp; \\text{Set \\( R2 \\) \\( \\leftarrow \\) busy;} \\\\<br>\n\\text{S5:} &amp; \\text{Use \\( R1 \\) and \\( R2 \\);} &amp; \\text{Q5:} &amp; \\text{Use \\( R1 \\) and \\( R2 \\);} \\\\<br>\n\\text{S6:} &amp; \\text{Set \\( R1 \\) \\( \\leftarrow \\) free;} &amp; \\text{Q6:} &amp; \\text{Set \\( R2 \\) \\( \\leftarrow \\) free;} \\\\&nbsp;&nbsp;<br>\n\\text{S7:} &amp; \\text{Set \\( R2 \\) \\( \\leftarrow \\) free;} &amp; \\text{Q7:} &amp; \\text{Set \\( R1 \\) \\( \\leftarrow \\) free;} \\\\\\hline&nbsp; &nbsp;&nbsp;&nbsp; \\end{array} \\]</p>\n\n</div><br><br><b>GATE CSE 2001 | Question: 19</b></p>",
          "type": "numeric",
          "options": [
            "<p>Is mutual exclusion guaranteed for \\( R1 \\) and \\( R2 \\)? If not show a possible interleaving of the statements of \\( P1 \\) and \\( P2 \\) such mutual exclusion is violated (i.e., both \\( P1 \\) and \\( P2 \\) use \\( R1 \\) and \\( R2 \\) at the same time).</p>",
            "<p>Can deadlock occur in the above program? If yes, show a possible interleaving of the statements of \\( P1 \\) and \\( P2 \\) leading to deadlock.</p>",
            "<p>Exchange the statements \\( Q1 \\) and \\( Q3 \\) and statements \\( Q2 \\) and \\( Q4 \\). Is mutual exclusion guaranteed now? Can deadlock occur?</p>"
          ],
          "correct_answer": "N/A",
          "marks": 1,
          "negative_marks": 0,
          "explanation": "<p><a href=\"https://gateoverflow.in/760/gate-cse-2001-question-19\" target=\"_blank\">https://gateoverflow.in/760/gate-cse-2001-question-19</a></p>"
        },
        {
          "id": 12,
