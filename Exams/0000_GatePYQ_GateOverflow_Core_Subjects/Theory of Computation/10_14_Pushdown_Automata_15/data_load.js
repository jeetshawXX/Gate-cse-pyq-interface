  ...
  "sections": [
    {
      ...
      "questions": [
        {
          "id": 1,
          "question": "<p><a name=\"2765\"></a><div itemprop=\"text\"><p>Let \\( Q=\\left( \\left\\{q_1,q_2 \\right\\}, \\left\\{a,b\\right \\}, \\left\\{a,b,\\bot \\right\\}, \\delta, \\bot, \\phi \\right) \\) be a pushdown automaton accepting by empty stack for the language which is the set of all nonempty even palindromes over the set \\( \\left\\{a,b\\right\\} \\). Below is an incomplete specification of the transitions \\( \\delta \\). Complete the specification. The top of the stack is assumed to be at the right end of the string representing stack contents.</p>\n\n<ol>\n\t<li>\\( \\delta(q_1,a,\\bot) = \\left\\{(q_1, \\bot a)\\right\\} \\)&nbsp;</li>\n\t<li>\\( \\delta(q_1,b,\\bot) = \\left\\{(q_1, \\bot b)\\right\\} \\)&nbsp;</li>\n\t<li>\\( \\delta(q_1,a,a) = \\left\\{(q_1, aa)\\right\\} \\)&nbsp;</li>\n\t<li>\\( \\delta(q_1,b,a) = \\left\\{(q_1, ab)\\right\\} \\)&nbsp;</li>\n\t<li>\\( \\delta(q_1,a,b) = \\left\\{(q_1, ba)\\right\\} \\)&nbsp;</li>\n\t<li>\\( \\delta(q_1,b,b) = \\left\\{(q_1, bb)\\right\\} \\)&nbsp;</li>\n\t<li>\\( \\delta(q_1,a,a) = \\left\\{(\\dots, \\dots)\\right\\} \\)&nbsp;</li>\n\t<li>\\( \\delta(q_1,b,b) = \\left\\{(\\dots, \\dots)\\right\\} \\)&nbsp;</li>\n\t<li>\\( \\delta(q_2,a,a) = \\left\\{(q_2, \\epsilon)\\right\\} \\)&nbsp;</li>\n\t<li>\\( \\delta(q_2,b,b) = \\left\\{(q_2, \\epsilon)\\right\\} \\)&nbsp;</li>\n\t<li>\\( \\delta(q_2,\\epsilon,\\bot) = \\left\\{(q_2, \\epsilon)\\right\\} \\)&nbsp;</li>\n</ol></div><br><br><b>GATE CSE 1996 | Question: 13</b></p>",
          "type": "numeric",
          "options": [],
          "correct_answer": "N/A",
          "marks": 1,
          "negative_marks": 0,
          "explanation": "<p><a href=\"https://gateoverflow.in/2765/gate-cse-1996-question-13\" target=\"_blank\">https://gateoverflow.in/2765/gate-cse-1996-question-13</a></p>"
        },
        {
          "id": 2,
        ...
        {
          "id": 3,
          "question": "<p><a name=\"1727\"></a><div itemprop=\"text\"><p>Let \\( M=(\\{q_0, q_1\\}, \\{0, 1\\}, \\{z_0, X\\}, \\delta, q_0, z_0, \\phi) \\) be a Pushdown automation where \\( \\delta \\) is given by</p>\n\n<p>\\( \\delta(q_0, 1, z_0) = \\{(q_0, Xz_0)\\} \\)</p>\n\n<p>\\( \\delta(q_0, \\epsilon, z_0) = \\{(q_0, \\epsilon)\\} \\)</p>\n\n<p>\\( \\delta(q_0, 1, X) = \\{(q_0, XX)\\} \\)</p>\n\n<p>\\( \\delta(q_1, 1, X) = \\{(q_1, \\epsilon)\\} \\)</p>\n\n<p>\\( \\delta(q_0, 0, X) = \\{(q_1, X)\\} \\)</p>\n\n<p>\\( \\delta(q_0, 0, z_0) = \\{(q_0, z_0)\\} \\)<br>\n&nbsp;</p>\n\n<ol style=\"list-style-type:lower-alpha\">\n<li>\n<p>What is the language accepted by this PDA by empty stack?</p>\n</li>\n<li>\n<p>Describe informally the working of the PDA</p>\n</li>\n</ol></div><br><br><b>GATE CSE 1998 | Question: 13</b></p>",
          "type": "numeric",
          "options": [],
          "correct_answer": "N/A",
          "marks": 1,
          "negative_marks": 0,
          "explanation": "<p><a href=\"https://gateoverflow.in/1727/gate-cse-1998-question-13\" target=\"_blank\">https://gateoverflow.in/1727/gate-cse-1998-question-13</a></p>"
        },
        {
          "id": 4,
        ...
        {
          "id": 5,
          "question": "<p><a name=\"679\"></a><div itemprop=\"text\"><p>A push down automation (pda) is given in the following extended notation of finite state diagram:</p>\n\n<p style=\"text-align:center\"><img alt=\"\" height=\"198\" src=\"images/gateOverflow_pyq_images/theory_of_computation___pushdown_automata/51361c0daacbcfd8106ef0d1e5e06771.png\" width=\"408\"></p>\n\n<p>The nodes denote the states while the edges denote the moves of the pda. The edge labels are of the form \\( d \\), \\( s/s' \\) where \\( d \\) is the input symbol read and \\( s, s' \\) are the stack contents before and after the move. For example the edge labeled \\( 1, s/1.s \\) denotes the move from state \\( q_0 \\) to \\( q_0 \\) in which the input symbol \\( 1 \\) is read and pushed to the stack.</p>\n\n</div><br><br><b>GATE CSE 2000 | Question: 8</b></p>",
          "type": "numeric",
          "options": [
            "<p>Introduce two edges with appropriate labels in the above diagram so that the resulting pda accepts the language \\( \\left\\{x2x^{R} \\mid x \\in \\left\\{0,1\\right\\}^*,x^{R} \\text{ denotes reverse of x}\\right\\} \\),&nbsp;by empty stack.</p>",
            "<p>Describe a non-deterministic pda with three states in the above notation that accept the language \\( \\left\\{0^{n}1^{m} \\mid n \\leq m \\leq 2n\\right\\} \\) by empty stack</p>"
          ],
          "correct_answer": "N/A",
          "marks": 1,
          "negative_marks": 0,
          "explanation": "<p><a href=\"https://gateoverflow.in/679/gate-cse-2000-question-8\" target=\"_blank\">https://gateoverflow.in/679/gate-cse-2000-question-8</a></p>"
        },
        {
          "id": 6,
          "question": "<p><a name=\"747\"></a><div itemprop=\"text\">Give a deterministic PDA for the language \\( L=\\{a^ncb^{2n} \\mid n \\geq 1\\} \\) over the alphabet \\( \\Sigma = \\{a,b,c\\} \\). Specify the acceptance state.</div><br><br><b>GATE CSE 2001 | Question: 6</b></p>",
          "type": "numeric",
          "options": [],
          "correct_answer": "N/A",
          "marks": 1,
          "negative_marks": 0,
          "explanation": "<p><a href=\"https://gateoverflow.in/747/gate-cse-2001-question-6\" target=\"_blank\">https://gateoverflow.in/747/gate-cse-2001-question-6</a></p>"
        },
        {
          "id": 7,
        ...
        {
          "id": 11,
          "question": "<p><a name=\"399281\"></a><div itemprop=\"text\"><p>Consider the pushdown automaton \\( \\text{(PDA)}\\;P \\) below, which runs on the input alphabet \\( \\{a, b\\} \\), has stack alphabet \\( \\{\\perp, A\\} \\), and has three states \\( \\{s, p, q\\} \\), with \\( s \\) being the start state. A transition from state \\( u \\) to state \\( v \\), labelled \\( c / X / \\gamma \\), where \\( c \\) is an input symbol or \\( \\epsilon, X \\) is a stack symbol, and \\( \\gamma \\) is a string of stack symbols, represents the fact that in state \\( u \\), the \\( \\text{(PDA)} \\) can read \\( c \\) from the input, with \\( X \\) on the top of its stack, pop \\( X \\) from the stack, push in the string \\( \\gamma \\) on the stack, and go to state \\( v \\). In the initial configuration, the stack has only the symbol \\( \\perp \\) in it. The \\( \\text{(PDA)} \\) accepts by empty stack.</p><p style=\"text-align:center\"><img alt=\"\" width=\"350\" height=\"395\" src=\"images/gateOverflow_pyq_images/theory_of_computation___pushdown_automata/89b27f71f31d6c9ce7b61402256353f0.png\"></p><p>Which one of the following options correctly describes the language accepted by \\( P ? \\)</p></div><br><br><b>GATE CSE 2023 | Question: 30</b></p>",
          "type": "single",
          "options": [
